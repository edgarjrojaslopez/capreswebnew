const Content = () => {
  return (
    <div className="relative mx-8 mb-10 -mt-6 flex flex-col-reverse py-2 md:py-16 lg:flex-col lg:py-0">
      <div className="mx-auto w-full max-w-xl px-4 md:px-0 lg:max-w-screen-xl lg:px-8 lg:py-20">
        <div className="mb-0 lg:max-w-lg lg:pr-8 xl:pr-6">
          ...
          <p className="mb-5 text-base text-gray-700 md:text-center md:text-lg">
      ...
      <div className="inset-y-0 top-0 right-0 mx-auto mb-6 w-full max-w-xl px-4 md:px-0 lg:absolute lg:mx-0 lg:mb-0 lg:w-1/2 lg:max-w-full lg:pl-8 lg:pr-0 xl:px-0">
        <img
